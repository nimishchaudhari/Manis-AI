...
const webSearchAgent_js_1 = require("./webSearchAgent.js");
Object.defineProperty(exports, "WebSearchAgent", { enumerable: true, get: function () { return webSearchAgent_js_1.WebSearchAgent; } });
...
async function main() {
    ...
    const logger = (0, shared_utils_1.createLogger)('web-search-agent-main');
    const agent = new webSearchAgent_js_1.WebSearchAgent(config);
    try {
...
exports.default = webSearchAgent_js_1.WebSearchAgent;
